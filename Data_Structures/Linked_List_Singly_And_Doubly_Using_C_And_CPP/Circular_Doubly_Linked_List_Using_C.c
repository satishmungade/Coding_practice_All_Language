...
int SearchAll(PNODE pHead,PNODE pTail,int iKey)    
{
    int iCount =0;
    if(NULL == pHead)
    {
...
int SearchFirstOcc(PNODE pHead,PNODE pTail,int iKey)    
{
...
int SearchLastOccPNODE pHead,PNODE pTail,int iKey)
{
 	int iPosition = -1,iCount=0;
