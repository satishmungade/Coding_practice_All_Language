...
for_statement_scan_outer2:
	...
	movl 	-20(%ebp),%ecx				#pointer
	movl 	%eax,(%ecx,%edx,4)			#arra[icounter1]
	...
	for_statement_scan_inner4:
			...
			movl	-12(%ebp),%eax
			movl	-20(%ebp),%edx
			movl    (%edx,%eax,4),%ebx 		#arr[icounter]
			
			movl	-16(%ebp),%eax			#arr[icounter1][iCounter2]
			leal	(%ebx,%eax,4),%edx 		#&arr[icounter1][iCounter2]
...
for_statement_print_outer2:
	...
	for_statement_print_inner4:
		movl	-20(%ebp),%ebx
		movl	-12(%ebp),%edx
		movl    (%ebx,%edx,4),%eax    #arr[iCounter]

		movl	-16(%ebp),%edx
		movl    (%eax,%edx,4),%ecx	#arr[iCounter][iCounter2]
		movl    -12(%ebp),%eax

		pushl 	%ecx			#arr[iCounter][iCounter2]
		pushl 	%edx
		pushl  	%eax
